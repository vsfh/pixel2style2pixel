...
class TrainOptions:
	...
	def initialize(self):
		self.parser.add_argument('--exp_dir', default='./runs', type=str, help='Path to experiment output directory')
		...
		self.parser.add_argument('--scale', default='4', type=str, help='Number of input image channels to the psp encoder')
		self.parser.add_argument('--n_feats', default=32, type=int, help='Number of input label channels to the psp encoder')
		self.parser.add_argument('--output_size', default=1024, type=int, help='Output size of generator')
		self.parser.add_argument('--rgb_range', default=255, type=int, help='Output size of generator')
		self.parser.add_argument('--n_colors', default=3, type=int, help='Output size of generator')
